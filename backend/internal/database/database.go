...
import (
	...
	loggerConfig "github.com/eulerbutcooler/go-blrplt/internal/logger"
...
func New(cfg *config.Config, log *zerolog.Logger, loggerService *loggerConfig.LoggerService) (*Database, error) {
